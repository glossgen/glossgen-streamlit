...
class InstructionsTab:
    """Manages the instructions tab UI components"""
    
    def __init__(self):
        self.config = AppConfig()
        self.about_text = self._load_about_text()
            
    def render(self) -> None:
        """Render the instructions tab content"""
        st.markdown(self.about_text)
    
    def _load_about_text(self) -> str:
        """Load about text from file or generate default"""
        try:
            if os.path.exists("./assets/about.md"):
                with open("./assets/about.md", "r", encoding="utf-8") as file:
                    return file.read()
            else:
                return self._generate_default_about_text()
        except Exception:
            return self._generate_default_about_text()
    
    def _generate_default_about_text(self) -> str:
        ...
        ## Exploring Tables <a name="exploring-tables"></a>
        ...
        ## Generating Glossaries <a name="generating-glossaries"></a>
        ...
        ## Visualizing Relationships <a name="visualizing-relationships"></a>
        ...
        ## Creating Table Descriptions <a name="creating-table-descriptions"></a>
        ...
        ## Exporting Documentation <a name="exporting-documentation"></a>
        ...
        - **Complete Documentation**: Export everything from the Export tab

        The exported files include timestamps and database names for easy identification.

        ## AI Provider Settings <a name="ai-provider-settings"></a>
        ...
        **Data Privacy**
        ...
        For more information, visit the [GlossGen GitHub repository](https://github.com/yourusername/glossgen).
        """
